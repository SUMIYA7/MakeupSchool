...
const Login = () => {
    ...
    return (
      <>
        <Helmet>
          <title>Makeup School | Login</title>
        </Helmet>
        <div className="hero min-h-screen bg-gray-300">
          <div className="hero-content flex-col md:flex-row-reverse">
            <div className="text-center md:w-1/2 lg:text-left text-black">
              <h1 className="text-5xl font-bold">Makeup School</h1>
              <p className="py-6">
                This is The School of Makeup and Cosmetology.Here you can learn so many things about your face,eyes,hair,skin & cosmetics.Hope you have a good learning.
              </p>
            </div>
