          ...
          <div className="flex my-4">
            <div className="form-control w-full ">
              ...
              >
                ...
                <option>Learn Basic skin care</option>
                <option>Learn Hair color & treatment</option>
                <option>Gorgeous Eye Makeup</option>
                <option>Making perfect skin</option>
                <option>Good Cosmetics usage</option>
              </select>
            </div>
